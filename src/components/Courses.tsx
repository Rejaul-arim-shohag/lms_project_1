...
export default function Courses() {
    ...
    return (
        <div className="my-20 -z-50 bg-right-bottom bg-[url('/images/courses_bg_iamge.png')]">
            <h2 className="text-4xl font-semibold text-center ">ক্যারিয়ার গোল সেট করে যাত্রা শুরু করুন</h2>
                ...
                {cards.map((card, index) => (
                    <div 
                        ...
                        <div className="mt-12">
                            ...
                            <p className="mb-4 text-sm text-base text-neutral-600 dark:text-neutral-200 text-center	">
                                {card.description}
                            </p>
                        </div>

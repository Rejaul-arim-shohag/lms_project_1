...
export default function ReviewSwip() {
  const reviewers = [
    {
      name: "Neil Sims",
  ...
  return (
    <div className="min-w-full ">
      <div className=" border-2 p-4 px-6 bg-background rounded-2xl ">
        ...
        <div>
          <p className="text-lg">
            ইউআই ইউএক্স কোর্সটি স্কিল ডেভেলপমেন্টের জন্য অনেক হেল্পফুল একটি
            কোর্স। আমার প্রতিটি প্রবলেমই তারা লাইভ ক্লাসেই সলভ করার চেষ্টা
            করেছে। এছাড়াও সাপোর্ট ইন্সট্রাক্টররাও অনেক ভালো। এসব কারণেই ইউআই
            ইউএক্স এর লার্নিং জার্নিটা আমার জন্য ছিল অসাধারণ।
          </p>
        </div>
